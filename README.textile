...
bc.. #<Chronatog::Server::Customer id: 1, service_id: nil, name: "some-account", created_at: "2012-04-16 10:49:13", updated_at: "2012-04-16 10:49:13", api_url: "http://services.engineyard.com/api/1/partners/2/ser...", messages_url: "http://services.engineyard.com/api/1/partners/2/ser...", invoices_url: "http://services.engineyard.com/api/1/partners/2/ser...", plan_type: "freemium", last_billed_at: nil>
...
bc.. https://chronatog.engineyard.com/eyintegration/sso/customers/1?access_level=owner&ey_return_to_url=https%3A%2F%2Fcloud.engineyard.com%2Fdashboard&ey_user_id=57&ey_user_name=Person+Name&timestamp=2012-04-16T10%3A49%3A14-07%3A00&signature=AuthHMAC+123edf%3ApFKyNVjNLSmk5OoBWalma9Z8Edo%3D
...
bc.. #<Chronatog::Server::Scheduler id: 1, customer_id: 1, auth_username: "Ue9cf11538398f2", auth_password: "Pf3b0e0aebd438b80095fdee479", created_at: "2012-04-16 10:49:14", updated_at: "2012-04-16 10:49:14", api_url: "http://services.engineyard.com/api/1/service_accoun...", environment_name: "myenv", app_name: "myapp", messages_url: "http://services.engineyard.com/api/1/partners/112/s...", decomissioned_at: nil, usage_calls: 0>
...
bc.. {
  "provisioned_service": {
    ...
    "vars": {
      ...
      "auth_username": "U3a8061aa04dbc8",
      "auth_password": "P23784ad660d59f8f4e67c0d33e"
    }
  }, 
  "message": {
    "message_type": "status", 
...
When schedulers are provisioned we save an "api_url".  We can use this URL to update our "vars".

For example:

bc.. POST http://services.engineyard.com/api/1/service_accounts/104/provisioned_service/109
{
  "provisioned_service": {
    "vars": {
      "auth_username": "Ub801daa3f5d4fd",
      "auth_password": "P0ecdb424239541b18ad41667c6"
    }
  }
}
...
chronatog:
  service_url: https://chronatog.engineyard.com/chronatogapi/1/jobs
  auth_username: Udfec8edd08bb9a
  auth_password: Pd62b816114cfa3d32787d56982
...
bc.. POST http://services.engineyard.com/api/1/partners/80/services/81/service_accounts/85/invoices
{
  "invoice": {
    ...
    "line_item_description": "For service from 2012/04/15 to 2012/04/16 includes 1 schedulers and 5 jobs run."
  }
}
