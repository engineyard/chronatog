...
bc.. $ script/console
> registration_url = "http://services.engineyard.com/api/1/partners/4/services"
...
=> #<Chronatog::Server::Service id: 1, name: "Chronatog", state: "registered", url: "http://services.engineyard.com/api/1/partners/4/ser...", created_at: "2011-10-03 15:44:08", updated_at: "2011-10-03 15:44:08">
...
bc.. POST "http://chronatog.example.com/eyintegration/api/1/customers"
{
  "invoices_url" => "http://services.engineyard.com/api/1/partners/1/services/1/service_accounts/1/invoices", 
  "name"         => "some-account", 
  "url"          => "http://services.engineyard.com/api/1/partners/1/services/1/service_accounts/1", 
  "messages_url" => "http://services.engineyard.com/api/1/partners/1/services/1/service_accounts/1/messages"
}

p. Chronatog will handle the callback with the implementation defined in @Chronatog::EyIntegration::Application@ as:

bc.. service_account = EY::ServicesAPI::ServiceAccountCreation.from_request(json_body)
...
bc.. #<Chronatog::Server::Customer id: 1, service_id: 1, name: "some-account", created_at: "2011-10-03 15:44:08", updated_at: "2011-10-03 15:44:08", api_url: "http://services.engineyard.com/api/1/partners/0/ser...", messages_url: "http://services.engineyard.com/api/1/partners/0/ser...", invoices_url: "http://services.engineyard.com/api/1/partners/0/ser...", plan_type: nil, last_billed_at: nil>
...
response = EY::ServicesAPI::ServiceAccountResponse.new(:configuration_required => false,
                                                       :configuration_url        => customer.configuration_url(base_url),
                                                       :provisioned_services_url => customer.provisioned_services_url(base_url),
                                                       :url                      => customer.url(base_url),
                                                       :message                  => EY::ServicesAPI::Message.new(:message_type => "status", :subject => customer.singup_message))
