#TODO: remove this line when lisonja is release as gem
...
EOT
    ...
    get "/sso/customers/:customer_id" do |customer_id|
      raise "Signature invalid" unless EY::ApiHMAC::SSO.authenticated?(request.url, Lisonja.api_creds.auth_id, Lisonja.api_creds.auth_key)
      @customer = Lisonja::Customer.find(customer_id)
